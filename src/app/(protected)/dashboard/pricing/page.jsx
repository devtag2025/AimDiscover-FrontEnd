...
export default function PricingPage() {
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      {/* Backgrounds */}
      <div className="fixed inset-0 bg-gradient-to-b from-purple-950/20 via-black to-black pointer-events-none" />
      <div className="fixed top-0 left-1/3 w-[600px] h-[600px] bg-purple-600/10 rounded-full blur-[128px]" />
      <div className="fixed bottom-0 right-1/3 w-[600px] h-[600px] bg-blue-600/10 rounded-full blur-[128px]" />

      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        {/* Header */}
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-semibold text-neutral-50 mb-4">
            Simple, transparent pricing
          </h1>
            ...
            <div className="inline-flex p-1 bg-neutral-900 rounded-xl border border-neutral-800">
              <button
                ...
                className={`px-5 py-2 rounded-lg text-sm ${
                  !isYearly ? "bg-purple-600 text-white" : "text-neutral-400"
                }`}
              >
                Monthly
              </button>
          ...
          {plans.map((plan, index) => {
            ...
            return (
              <motion.div
                ...
                className={`relative p-8 rounded-xl border backdrop-blur ${
                  plan.popular
              ...
              >
                ...
                <button
                  ...
                  className="w-full py-3 rounded-lg bg-purple-600 text-white disabled:opacity-50"
                >
