...
export function LoginForm() {
  ...
  const handleGoogleAuth = () => {
    // ✅ Pass redirect URL to Google auth if needed
    const redirectUrl = searchParams.get("redirect") || "/dashboard";
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 mt-8">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center">
              ...
              <label
                htmlFor="remember-me"
                className="ml-3 block text-sm text-neutral-300 font-medium cursor-pointer"
              >
                Remember me
              </label>
            </div>
            ...
            <div>
              <Link
                ...
                className="text-purple-500 font-medium text-sm hover:text-purple-400 transition-colors duration-200"
              >
                Forgot Password?
              </Link>
            </div>
